...
use object::{
    Architecture, LittleEndian, Object, ObjectSection, ObjectSymbol, RelocationEncoding, RelocationKind, SectionKind, pod,
};
use tempfile::{TempDir, tempdir};

use crate::embed::coff::MachineType;
use crate::embed::{TargetOs, create_object_file, link_manifest_gnu, link_manifest_msvc};
